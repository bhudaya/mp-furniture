...
<div class="content-wrapper">
	<section class="content-header">
 	...
 	<input type="hidden" id="url_getsubcategory" value="<c:url value="/pcategory/sub/listbypcategory/json" />">
 	<input type="hidden" id="url_getspeccategory" value="<c:url value="/pcategory/spec/listbypcategory/json" />">
 	<input type="hidden" id="url_getattrcategory" value="<c:url value="/pcategory/attr/listbypcategory/json" />">
 	<input type="hidden" id="url_generatesku" value="<c:url value="/tempproduct/sku/generate/json" />">

 	<section class="content">
 	<form id="form_" action="<c:url value="/tempproduct/create"/>" method="post" onsubmit="return form_submit();" enctype="multipart/form-data">
