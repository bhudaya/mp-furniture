 			...
 			<div class="row">
			    <div class="col-lg-3 col-sm-6 col-xs-12">
			      <div class="small-box bg-blue">
			        <div class="inner">
			          <h3>${prodbean.sumApproved}</h3>
			          <p>Products</p>
			        </div>
			        <div class="icon">
			          <i class="fa fa-shopping-bag"></i>
			        </div>
			        <a href="<c:url value="/tempproduct/create" />" class="small-box-footer">
			          Create
			          <i class="fa fa-cog"></i>
			        </a>
			      </div>
			    ...
			    <div class="col-lg-3 col-sm-6 col-xs-12">
			      <div class="small-box bg-green">
			        <div class="inner">
			          <h3>${prodbean.sumApproval}</h3>
			          <p>Request Approval</p>
			        </div>
			        <div class="icon">
			          <i class="fa fa-shopping-bag"></i>
			        </div>
			        <a href="<c:url value="/tempproduct" />" class="small-box-footer">
			          View
			          <i class="fa fa-cog"></i>
			        </a>
			      </div>
