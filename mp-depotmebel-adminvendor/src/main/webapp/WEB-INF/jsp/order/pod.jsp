...
<div class="content-wrapper">
	<section class="content-header">
    	<h1>
        	POD
        	<!-- <small>View transaction which requires Quality Control</small> -->
      	</h1>
      	<ol class="breadcrumb">
    ...
    <section class="content">
    	<form method="post" action="<c:url value="/order/pod" />" onsubmit="return btn_pod();" enctype="multipart/form-data"> 
		      	...
		      	<div class="box box-default">
		        	...
		        	<div class="box-footer">
			          <div class="form-group">
			            ...
			            <input type="file" id="img_pod" name="img_pod" class="form-control" required="required">
			          </div>
			          <div class="form-group">
			            <label class="control-label">Receiver Name</label>
			            <input type="text" id="receiver_name" name="receiver_name" class="form-control" required="required">
			          </div>
			          <div class="form-group">
			            <label class="control-label">Receiver Phone</label>
			            <input type="text" id="receiver_phone" name="receiver_phone" class="form-control" required="required">
			          </div>
			          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#submitPod">Submit POD</button>
			        </div>
		      	</div>
		    </div>
		</div>
 
 		<div class="modal fade" tabindex="-1" role="dialog" id="submitPod">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title">POD submission confirmation</h4>
		      </div>
		      <div class="modal-body">
		        <p>Submit proof of delivery?</p>
		      </div>
...
function btn_pod() {
	...
	var rec_phone = $("#receiver_phone").val();
	...
	if(rec_phone==''){
		alert('Please insert receiver phone');
		return false;
	}else{	
	}
