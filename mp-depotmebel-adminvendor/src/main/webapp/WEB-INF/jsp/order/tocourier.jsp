...
<div class="content-wrapper">
    ...
    <section class="content">
    	<form method="post" action="<c:url value="/order/tocourier" />" onsubmit="return btn_to_courier();"> 
		     	...
		     	<!--All orders: Need QC-->
		      	<div class="box box-default">
		        	...
		        	<div class="box-footer">
		          		<div class="form-group">
		            		<label class="control-label">Select Courier</label>
		            		<select name="courier_id" class="form-control" required="required">
		              			<option value="">-</option>
		              			<c:forEach items="${bean.couriers}" var="courier">
		              				<option value="${courier[0]}">${courier[1]}</option>
		              			</c:forEach>
		            		</select>
		          		</div>
		          		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#toCourier">Assign</button>
		        	</div>
		      	</div>
		    </div>
		</div>
 
 		<div class="modal fade" tabindex="-1" role="dialog" id="toCourier">
...
function btn_to_courier() {
	console.log("btn_to_courier");
	return true;
}
</script>
